...
# Load in first file
dat1 <- readNifti("Mean BOLD Signal Re-creation/UM_1_0050363_func_preproc.nii.gz")
dim(dat1)
...
ABIDE <- read.table("Preprocessed Data/cpac_nofilt_noglobal_rois_aal/UM_1_0050363_rois_aal.1D",
