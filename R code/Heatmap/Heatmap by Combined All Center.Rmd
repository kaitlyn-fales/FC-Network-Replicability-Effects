---
title: "Heatmap by Combined All Center"
author: "Xurui Zhi"
date: "2024-04-12"
...
for (center in names(center_data)) {
  ...
  # Save the heatmap
  ggsave(filename = paste0("all.combined_heatmap_", gsub("[[:punct:]]", "", center), ".png"), plot = p, width = 10, height = 8)
}
```
